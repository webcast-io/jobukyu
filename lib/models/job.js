...
function processWebhook (webhook, metadata) {
  ...
  {
  case 'post':
    request.post({url: webhook.url, body: metadata, json: true});
    break;
  case 'put':
    request.put({url: webhook.url, body: metadata, json: true});
    break;
  case 'patch':
    request.del({url: webhook.url, body: metadata, json: true});
    break;
  case 'delete':
    request.del({url: webhook.url, json: true});
    break;
  // get
  default:
    request(webhook.url);
